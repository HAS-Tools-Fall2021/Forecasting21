...
# %%
# print a summary
print('Scoring forecasts for week', forecast_week, ':', start_date, '-',
      stop_date)
...
print('Second Place = ',
      list(summary.loc[summary['1week_ranking'] == 2].index),
...
print('Second Place = ',
      list(summary.loc[summary['2week_ranking'] == 2].index),
...
title_string = 'Week ' + str(forecast_week) + ' Forecasts (' +\
