...
# %%
forecast_week = 14  # CHANGE to reflect current week
...
forecasts_2 = np.zeros([nstudent, forecast_week])  # 2wk forecast for this week
...
# forecasts issued with 1 week lead time
weekly_forecast1w = pd.DataFrame({}, index=firstnames)
# forecasts issued with 2 weeks lead time
